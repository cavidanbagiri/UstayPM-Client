...
<template>
    <Warehouse_Table_Body_Each_Row v-for="(each, index) in warehouse_store.warehouse_data" :each="each" :index="index"
...
import Warehouse_Table_Body_Each_Row from './Warehouse_Table_Body_Each_Row.vue'
import WarehouseStore from '../../../store/store.warehouse';
const warehouse_store = WarehouseStore();

const addChecked = (item) => {
    warehouse_store.return_checked_values.push(item);
    console.log('item ius : ', warehouse_store.return_checked_values);
}
