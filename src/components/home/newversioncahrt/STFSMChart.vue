    ...
    <div class="grid grid-cols-12 gap-6 my-3 ">
        ...
        <div class="col-span-5  my-3 rounded-xl flex flex-col items-center justify-between "
            ...
            <div class="w-full h-full flex flex-row">
                <div class="flex flex-col w-full h-full  ">
                    <div class="flex flex-col h-full m-1 bg-white rounded-xl">
                        <div class="flex flex-row justify-between items-start rounded-xl ">
                            <div class="flex flex-col mt-4 ml-4">
                                <span class="text-3xl" >Project</span>
                                <span class="text-4xl font-bold mt-4" >457</span>
                            </div>
                            <div class="w-20 h-20 bg-blue-400 flex justify-center items-center rounded-full mr-4 mt-4">
                                <i class="fa-solid fa-bars-progress fa-xl text-white"></i>   
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col h-full m-1 bg-white rounded-xl">
        ...
        <!-- <div class="col-span-4 ml-3 bg-white rounded-xl flex flex-col items-center justify-between h-[30rem]"
            ...
            <div class="flex flex-col  w-full h-full items-center rounded-b-xl">
                <div class=" w-[15rem] h-[15rem] flex justify-center items-center" style="">
                    <img class="w-[12rem] h-[12rem] rounded-full"
                        src="https://blog.photofeeler.com/wp-content/uploads/2017/12/linkedin-profile-picture.jpg" alt="">
                </div>
