<template>
  ...
  <div v-if="prop.toggle_cancelstf"
    class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-40 flex justify-center items-center text-gray-600 z-20"
    ...
    <div
      ...
      <div class="flex flex-col w-full">
        ...
        <div class="flex justify-end">
          <span @click="closeCanceledSTF" class=" px-2 pt-2 pb-2">
        ...
        <div class="flex justify-center items-center mb-1">
          <span class="text-3xl  text-center text-gray-700 font-bold">
            Canceled STF
          </span>
        </div>
        ...
        <div class="flex flex-col mt-4 mx-2">
          ...
          <span class="text-xl px-2 py-2 text-gray-500 font-bold">Comment</span>
          <textarea
            class="h-40 py-3 px-2 border w-full mb-5 text-[15px] outline-none text-gray-400 hover:shadow-lg duration-300"
            type="area" name="" id="" placeholder="Comment Cant Be Empty" v-model="comment"></textarea>
        </div>

        <!-- STF Inform Title -->
        <div class="ml-2 pl-2 text-xl mt-4 text-gray-500 font-bold">
          <span>STF Information</span>
        </div>

        <!-- STF Information Section -->
        <div class="px-2 mx-2 text-[15px] flex justify-between items-center border-b mt-4 pb-1 ">
          <span>STF No: </span>
          <span class=" bg-orange-100 text-orange-500 py-1 px-2 rounded-lg">{{ prop.stf.stf_num }}</span>
        </div>

        <div class="px-2 mx-2 text-[15px] flex justify-between items-center border-b mt-4">
        ...
        <!-- STF Information Section -->
        <div class="px-2 mx-2 text-[15px] flex flex-col justify-start items-start border-b my-4 ">
          <span>Material Name: </span>
          <span class="mt-2 p-3 w-full bg-gray-100">{{ prop.stf.material_name }}</span>
        </div>
