<template>
    <div :class="anim_toggle ? 'mtf-anim-open' : 'mtf-anim-close'"
        class=" fixed shadow-2xl z-10 px-2 py-1 h-screen bg-gradient-to-r from-slate-700 to-slate-900 w-80 rounded-xl " style="font-family: 'Roboto', sans-serif;">
        ...
        <span
            ...
            <i class="fa-solid fa-chevron-left fa-sm text-gray-100 hover:text-gray-100"></i>
        </span>
        <!-- </div> -->
        <div
        ...
        <!-- Home Menu -->
        <div class="  mt-3 hover:bg-green-500 duration-300 rounded-lg py-1">
            <router-link to="/" class="flex items-center">
                ...
                <span class="text-gray-100 text-lg ps-3">
                    Home
                </span>
            </router-link>
        </div>
        ...
        <!-- Notification -->
        <div class=" relative mt-3 hover:bg-green-500 duration-300 rounded-lg py-1 flex items-center  cursor-pointer ">
            <div v-if="index_store.new_stf_notification?.length"
                class="badge  border-none text-gray-100 bg-red-500 badge-md absolute top-1 right-0 w-5 h-5 font-bold p-[11px]">
        ...
        <div  class=" relative mt-3 hover:bg-green-500 duration-300 rounded-lg py-1">
            <router-link to="/" class="flex items-center">
                ...
                <span @mouseover="messages_tooltip = true" @mouseleave="messages_tooltip = false"
                    class="rounded-md cursor-pointer w-10 h-10 flex flex-row justify-center items-center hover:bg-green-500 duration-300 py-1">
        ...
        <div v-if="!user_store.user" class="  mt-3 hover:bg-green-500 duration-300 rounded-lg py-1">
        ...
        <div v-else class="  mt-3 hover:bg-green-500 duration-300 rounded-lg py-1" @click="logout">
            <router-link to="/user/login" class="flex items-center">
