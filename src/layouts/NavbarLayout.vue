<template>
    <div class="flex flex-col justify-between h-screen bg-gradient-to-r from-slate-700 to-slate-900 w-[4.5rem] items-center pb-5 rounded-r-md 
  border-r-2">
        ...
        <div>
            ...
            <div class="relative mt-3">
                <div v-if="index_store.new_stf_notification?.length || index_store.accept_sms_notification?.length"
                    class="badge bg-red-500 border-none text-white badge-md absolute top-0 right-0 w-5 h-5 font-bold p-[11px]">
            ...
            <div class="relative mt-3">
                ...
                <MessagesNotificaion v-if="messages_notification_toggle"
                    @closeMessagesNotification="closeMessagesNotification" />
            </div>
